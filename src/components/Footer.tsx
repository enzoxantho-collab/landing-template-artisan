        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <a
                href={`tel:${PHONE}`}
                className="inline-flex items-center gap-2 text-white font-bold text-base hover:text-[var(--color-primary-light)] transition-colors"
              >
            ...
            <div>
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <a href={`tel:${PHONE}`} className="text-white font-bold hover:text-[var(--color-primary-light)] transition-colors">{PHONE_DISPLAY}</a>
                </div>
                <div>
