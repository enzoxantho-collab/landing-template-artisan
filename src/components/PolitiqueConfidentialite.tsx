  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl sm:text-4xl font-black text-[var(--color-primary)] mb-8">Politique de Confidentialité</h1>

        <div className="space-y-8 text-slate-600 leading-relaxed">
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Collecte des données</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Utilisation des données</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Services tiers</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Vos droits (RGPD)</h2>
            <p>
            ...
            <p className="mt-3">
              ...
              <a href={`tel:${PHONE}`} className="text-[var(--color-accent)] hover:underline font-semibold">
                {PHONE_DISPLAY}
              </a>.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Conservation des données</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Sécurité</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--color-primary)] mb-3">Contact</h2>
            <p>
